 ...
 */
public class RulesBook extends javax.swing.JFrame {

    private String rollNum ;
    /**
     * Creates new form RulesBook
     */
    public RulesBook() {
        initComponents();
    ...
    public RulesBook(String rollNum) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(jf, "Take A Deep Breath And Than Press Ohk Button");
        
        setVisible(false);
        new QuizPortal(rollNum).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RulesBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
